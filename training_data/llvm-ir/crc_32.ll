...
define dso_local i64 @crc32pseudo() local_unnamed_addr #0 {
  br label %1

1:                                                ; preds = %0, %1
  %2 = phi i64 [ 4294967295, %0 ], [ %11, %1 ]
  %3 = phi i32 [ 0, %0 ], [ %12, %1 ]
  %4 = tail call i32 @rand_beebs() #4
  %5 = zext i32 %4 to i64
  %6 = xor i64 %2, %5
  %7 = and i64 %6, 255
  %8 = getelementptr inbounds nuw [256 x i64], ptr @crc_32_tab, i64 0, i64 %7
...
declare i32 @rand_beebs() local_unnamed_addr #1
...
define internal fastcc range(i32 0, 32768) i32 @benchmark_body(i32 noundef range(i32 1, 171) %0, i32 noundef %1) unnamed_addr #3 {
  %3 = icmp eq i32 %1, 0
...
8:                                                ; preds = %8, %6
  %9 = phi i64 [ 4294967295, %6 ], [ %18, %8 ]
  %10 = phi i32 [ 0, %6 ], [ %19, %8 ]
  %11 = tail call i32 @rand_beebs() #4
  %12 = zext i32 %11 to i64
  %13 = xor i64 %9, %12
  %14 = and i64 %13, 255
  %15 = getelementptr inbounds nuw [256 x i64], ptr @crc_32_tab, i64 0, i64 %14
...
define dso_local range(i32 0, 32768) i32 @benchmark() local_unnamed_addr #3 {
  %1 = tail call fastcc i32 @benchmark_body(i32 noundef 170, i32 noundef 20)
  ret i32 %1
}
...
declare void @srand_beebs(i32 noundef) local_unnamed_addr #1
