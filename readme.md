...
5. Create conda environment `conda create -n myenv python=3.10`, activate environment, and then `pip install -r requirements.txt`
6. Run the bash script for the python file you want to run. eg: `sbatch inference.sh`
7. Terminal output will appear in the .log file specified in the bash script.